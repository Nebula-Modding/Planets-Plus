...
public class PlanetsPlusTiers {
    public static final Tier
            ...
            ROSINRITE = new SimpleTier(PlanetsPlusTags.PlanetsPlusBlockTags.NEEDS_ROSINRITE_TOOL, 1, 1, 1, 1, () -> Ingredient.of(PlanetsPlusTags.PlanetsPlusItemTags.INGOTS_ROSINRITE));
}